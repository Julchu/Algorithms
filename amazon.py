...
class Solution:
    ...
    def closestSquaredDistance(self, numRobots, positionX, positionY) -> int:
        # possibleCombinations = int(self.factorial(numRobots) // self.factorial(2) // self.factorial(numRobots - 2))
    ...
    def maxArea(self, height: List[int]) -> int:
        # possibleCombinations = int(self.factorial(len(height)) // self.factorial(2) // self.factorial(len(height) - 2))
        possibleCombinations = int(math.comb(len(height), 2))
